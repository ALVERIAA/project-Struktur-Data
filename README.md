...
```
.
├── fejhonii.py   # Frontend — Tampilan antarmuka Streamlit
├── fejhoni.py   # Backend — Logika bisnis, manajemen data, dan audio
└── README.md
```

### `fejhonii.py` — Frontend (UI)
